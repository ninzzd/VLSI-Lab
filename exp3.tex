...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/NOR_2/NOR_2_SCHEMATIC.png}
    \caption{CMOS 2-input NOR Gate Schematic}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/NOR_2/SHORTED_VTC/NOR_2_INPUTS_SHORTED_VTC.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/NOR_2/ONE_INPUT/ONE_INPUT_REG_VTC.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/NOR_2/SHORTED_VTC/SHORTED_FANOUT3_RISE_FALL.png}
    \caption{Rise-time and Fall-time for FANOUT of 3}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/NOR_3/nor3_sch.png}
    \caption{CMOS 3-input NOR Gate Schematic}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/NOR_3/SHORTED/NOR_3_SHORTED_VTC.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/NOR_3/NOT_SHORTED/NOR_3_ONE_INPUT_VTC.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/NOR_3/SHORTED/NOR_3_SHORTED_FANOUT_RISE_FALL.png}
    \caption{Rise-time and Fall-time for FANOUT of 3}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/JK_LATCH_NOR/JK_NOR_schm1.png}
    \caption{Schematic of JK Latch using NOR gates (1)}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/JK_LATCH_NOR/JK_NOR_schm2.png}
    \caption{Schematic of JK Latch using NOR gates (2)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/JK_LATCH_NOR/JK_LATCH_NOT_CLKQ.png}
    \caption{CLK to Q delay}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{exp3_NOR/JK_LATCH_NOR/JK_LATCH_NOR_CLK_DIN.png}
